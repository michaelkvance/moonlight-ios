...
@property (strong, nonatomic) IBOutlet UISlider *localDeadzoneSlider;
@property (strong, nonatomic) IBOutlet UISlider *remoteDeadzoneSlider;
@property (strong, nonatomic) IBOutlet UISegmentedControl *swapR2R3Selector;
